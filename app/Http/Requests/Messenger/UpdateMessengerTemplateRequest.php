...
class UpdateMessengerTemplateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        $rules = [
            ...
            'type' => 'sometimes|string|in:' . implode(',', MessengerTemplate::TYPES),
        ...
        // Add type-specific validation if payload is being updated
        if ($this->has('payload') && $type) {
    ...
    private function genericTemplateRules(): array
    {
        return [
            ...
            'payload.elements.*.image_url' => 'nullable|string',
    ...
    private function mediaTemplateRules(): array
    {
        return [
            ...
            'payload.elements.*.url' => 'nullable|string',
