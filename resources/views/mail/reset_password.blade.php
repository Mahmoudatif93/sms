                                    ...
                                    <table cellpadding="0" cellspacing="0" width="100%"
                                        ...
                                        <tr>
                                            <td align="right"
                                                ...
                                                <br>
                                                <p style="Margin:0;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px;direction: rtl;">
                                                    لإكمال العمليه  , يرجى الضغط علي  الرابط (Reset Password) الموضح أدناه. هذا  هو الرابط الخاص      .</p>
                                                <br>
                                                <p style="Margin:0;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px;direction: rtl;">
                                ...
                                <td align="center" valign="top" style="padding:0;Margin:0;width:560px">
                                    <table cellpadding="0" cellspacing="0" width="100%"
                                        ...
                                        <tr>
                                                ...
                                                <p style="font-size:12px;color:#888888;text-align:center;direction: rtl;">
                                                        أو يمكنك نسخ الرابط التالي في المتصفح:<br>
                                                        <a href="{{ $details['message'] }}" style="color:#5C68E2;">{{ $details['message'] }}</a>
                                                    </p>
