                                        ...
                                        <tr>
                                            <td align="center"
                                                ...
                                                <p style="Margin:0;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:24px;letter-spacing:0;color:#333333;font-size:20px;">
                                                    <strong>Wallet Transactions Export</strong></p>
                                                <p style="Margin:0;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#666666;font-size:14px;padding-top:10px;">
                                                    Your export file is ready for download</p>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                                    ...
                                    <table cellpadding="0" cellspacing="0" width="100%"
                                        ...
                                        <tr>
                                            <td align="center" style="Margin:0;padding:30px;">
                                                <p style="Margin:0;font-family:arial, 'helvetica neue', helvetica, sans-serif;font-size:14px;line-height:21px;color:#666666;padding-bottom:20px;">
                                                    Click the button below to download your wallet transactions export file.
                                                </p>
                                                ...
                                                <p style="Margin:0;font-family:arial, 'helvetica neue', helvetica, sans-serif;font-size:12px;line-height:18px;color:#999999;padding-top:20px;">
                                                    This link will expire in 1 hour.
                                                </p>

                                                <!-- Fallback link -->
                                                <p style="Margin:0;font-family:arial, 'helvetica neue', helvetica, sans-serif;font-size:11px;line-height:16px;color:#999999;padding-top:15px;">
                                                    If the button doesn't work, copy and paste this link in your browser:
                                                </p>
                                                <p style="Margin:0;font-family:arial, 'helvetica neue', helvetica, sans-serif;font-size:10px;line-height:14px;color:#6600ff;padding-top:5px;word-break:break-all;">
                                                    {{ $downloadUrl }}
                                                </p>
                                            </td>
                                        </tr>
                            ...
                            <tr>
                                <td align="left" valign="top" style="padding:0;Margin:0;width:560px">
                                    <table width="100%" role="presentation" cellpadding="0"
                                        ...
                                        <tr>
                                            <td align="center" style="padding:0;Margin:0">
                                                <p style="font-family:arial, 'helvetica neue', helvetica, sans-serif;font-size:14px;line-height:21px;color:#666666;text-align:center;">
                                                    If you have any questions, feel free to contact us.</p>
                                                <br>
                                                <p style="font-family:arial, 'helvetica neue', helvetica, sans-serif;font-size:12px;line-height:18px;color:#999999;text-align:center;">
                                                    This is an automated notification from the <strong>Dreams</strong> system.</p>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
