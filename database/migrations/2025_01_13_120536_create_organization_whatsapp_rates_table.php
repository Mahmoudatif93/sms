...
return new class extends Migration
{
    ...
    {
        Schema::create('organization_whatsapp_rates', function (Blueprint $table) {
            $table->id(); // Primary key
            $table->foreignUuid('organization_id')
                ->constrained()
                ->onDelete('cascade'); // Links to the Organization model
    ...
    public function down(): void
    {
        ...
        Schema::dropIfExists('organization_whatsapp_rates');
    }
};
