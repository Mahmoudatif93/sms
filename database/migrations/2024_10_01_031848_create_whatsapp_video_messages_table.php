...
return new class extends Migration {
    ...
    {
        Schema::create('whatsapp_video_messages', function (Blueprint $table) {
            $table->id();
    ...
    public function down(): void
    {
        ...
        Schema::table('whatsapp_video_messages', function (Blueprint $table) {
            $table->dropForeign(['whatsapp_message_id']); // Dropping the foreign key
        });
        Schema::dropIfExists('whatsapp_video_messages');
    }
};
