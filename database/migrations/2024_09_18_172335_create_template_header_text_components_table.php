...
return new class extends Migration
{
    ...
    {
        Schema::create('template_header_text_components', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('header_component_id');
            $table->string('text', 60)->comment('Text for TEXT headers, supports 1 variable and max 60 characters');
    ...
    {
        Schema::table('template_header_text_components', function (Blueprint $table) {
            $table->dropForeign(['header_component_id']);
        });
        Schema::dropIfExists('template_header_text_components');
    }
};
