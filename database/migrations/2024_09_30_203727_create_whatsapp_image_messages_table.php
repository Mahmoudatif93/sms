...
return new class extends Migration {
    ...
    {
        Schema::create('whatsapp_image_messages', function (Blueprint $table) {
            $table->id();
    ...
    public function down(): void
    {
        ...
        Schema::table('whatsapp_image_messages', function (Blueprint $table) {
            $table->dropForeign(['whatsapp_message_id']); // Dropping the foreign key
        });

        // Then drop the table
        Schema::dropIfExists('whatsapp_image_messages');
    }
};
