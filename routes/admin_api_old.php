...
// Resource Groups
Route::middleware(['auth:admin', 'check.admin', 'lang', 'admin.active'])
    ->prefix('api/admin/resource-groups')
...
Route::middleware(['auth:admin', 'check.admin', 'lang', 'admin.active'])
    ->prefix('api/admin/iam-policy-definitions')
...
Route::middleware(['auth:admin', 'check.admin', 'lang', 'admin.active'])
    ->prefix('api/admin/organizations/{organization}/workspaces')
...
Route::middleware(['auth:admin', 'check.admin', 'lang', 'admin.active'])
    ->prefix('api/admin/whatsapp-messages')
...
Route::middleware(['auth:admin', 'check.admin', 'lang', 'admin.active'])
    ->prefix('api/admin/whatsapp-rates')
...
Route::middleware(['auth:admin', 'check.admin', 'lang', 'admin.active'])
    ->prefix('api/admin/{organization}/whatsapp-rates')
...
Route::middleware(['auth:admin', 'check.admin', 'lang', 'admin.active'])
    ->prefix('api/admin/{organization}/membership-plans')
...
Route::middleware(['auth:admin', 'check.admin', 'lang', 'admin.active'])
    ->prefix('api/admin/dreams-whatsapp-rates')
...
Route::middleware(['auth:admin', 'check.admin', 'lang', 'admin.active'])
    ->prefix('api/admin/organizations/{organization}/whatsapp-extras')
